@if (session('ghl_sync_status'))
    <div class="rounded-md border border-teal-200 bg-teal-50 px-3 py-3 text-sm text-teal-900 dark:border-teal-500/30 dark:bg-teal-500/10 dark:text-teal-100 sm:px-4">
...
@if (session('ghl_sync_error'))
    <div class="rounded-md border border-amber-200 bg-amber-50 px-3 py-3 text-sm text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100 sm:px-4">
